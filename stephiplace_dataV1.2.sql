DROP DATABASE IF EXISTS `stephiplace_data_2`;
CREATE DATABASE IF NOT EXISTS `stephiplace_data_2`;

USE `stephiplace_data_2`;
...
CREATE TABLE `dependance`(
   ...
   dependance_surface VARCHAR(255),
...
INSERT INTO agence (agence_nom,agence_ville,agence_adresse,agence_codePostal,agence_img)
VALUES
('Stephiplace-Marseille','Marseille','109 Avenue de la Timone','13010','/img/agence1.jpg'),
('Stephiplace-Aix-en-Provence','Aix-en-Provence','57 Rue Espariat','13100','/img/agence2.jpg'),
('Stephiplace-Gardanne','Gardanne','38 Cours de la République','13120','/img/agence3.jpg')

INSERT INTO dependance (dependance_nom)
VALUES 
('piscine'),
('jardin'),
('parking'),
